...
// Call the printTable method to display the content of the table
                printTable(context);
        ...
        public static void printTable(Context context) {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    Log.d("Database", "State: " + state + ", Capital: " + capital + "Additional City 1:"+ additionalCity+ "Additional City 2:"+additionalCityy);
